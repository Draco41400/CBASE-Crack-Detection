...
class Model:
    def __init__(self,in_dir,save_folder=None):
        dataset = load_cached(cache_path='my_dataset_cache.pkl', in_dir= r'D:\School Stuff\CBASE\Master_Project\temp_images')
    ...
    def optimize(self, num_iterations):
        ...
        with tf.Session() as sess:
            ...
            for i in range(total_iterations,
                ...
                #print('error occurs here', (feed_dict_train))
...
def parse_arguments():
    ...
    parser.add_argument('--in_dir',dest='in_dir' ,type=str,default=r'D:\School Stuff\CBASE\Master_Project\temp_images')
    parser.add_argument('--iter',dest= 'num_iterations',type=int,default=1500)
    parser.add_argument('--save_folder',dest='save_folder' ,type=str,default=r'D:\School Stuff\CBASE\Master_Project\Pre-Built_AI\Use_this_one\Checkpoint')
    return parser.parse_args()

def  main(args):
    #in_dir = r'D:\School Stuff\CBASE\Master_Project\temp_images'
